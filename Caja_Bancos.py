...
with st.sidebar:
    ...
    st.link_button(
        "🔗 Ir a ChessERP",
        "https://venier.chesserp.com/AR173/#/dashboard",
        use_container_width=True,
        type="primary"
    )
...
with col1:
    with st.container(border=True):
        ...
        <div style="text-align: center; padding: 5px 0;">
            <h2 style="margin: 0; color: #1f77b4; font-size: 28px;">🏢</h2>
            <h4 style="margin: 4px 0; font-weight: 600; font-size: 13px;">ChessERP</h4>
            <p style="color: #666; font-size: 10px; margin: 2px 0 8px 0;">Sistema</p>
        </div>
        """, unsafe_allow_html=True)
        st.link_button(
            "🚀 Ir",
